      ...
      <div className="row">
        <div className="col one">
          <div className="welcome-message">
            <h1 className="fw-regular f-48">
              Hi, I'm <span className="nakia-blue">Noor Nabi</span>
            </h1>
            <p className="grey-white">Welcome to my page</p>
          </div>
          <div className="short-description">
            ...
            <br />
            <p>
              In my free time, I am either contributing to Open-Source projects
              or working on my cars.
            </p>
            <br />
            <p>I love talking about the world, hobbies and especially code.</p>
          </div>
        </div>
        <div className="col one text-center">
          <h1 className="fw-regular f-48">Want to hire me?</h1>
          <div className="d-grid">
            <div className="verticle-120">
